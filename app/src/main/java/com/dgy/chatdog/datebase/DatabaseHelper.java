...
public class DatabaseHelper extends SQLiteOpenHelper// 继承SQLiteOpenHelper类
{
    ...
    // 数据库名
    private static final String DATABASE_NAME = "DgyDogChat.db";

    public static final String MAIN_TABLE_NAME = "charttable";
    ...
    public void onCreate(SQLiteDatabase db)
    {
        ...
        sBuffer.append("CREATE TABLE [" + MAIN_TABLE_NAME + "] (");
        ...
        sBuffer.append("CREATE TABLE [" + ARTICLE_TABLE_NAME + "] (");
        sBuffer.append("[_id] INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT, ");
        sBuffer.append("[chartid] INTEGER,");
        sBuffer.append("[article] TEXT,");
        sBuffer.append("[source] TEXT,");
